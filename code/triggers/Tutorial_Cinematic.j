function Trig_Tutorial_Cinematic_Actions takes nothing returns nothing
    ...
    call SetUnitPositionLocFacingBJ(ArctUnit, udg_CinematicPosition, 90.00)
    ...
    call SetUnitTimeScalePercent(ArctUnit, 25.00)
    ...
    call SetUnitTimeScalePercent(ArctUnit, 10.00)
    call SetUnitAnimation(ArctUnit, "spell")
    ...
    call SetUnitVertexColorBJ(ArctUnit, 100, 100, 100, 0.00)
