function Trig_Abilities_Info_Conditions takes nothing returns boolean
    return GetUnitTypeId(GetTriggerUnit()) == 0x68303036
endfunction
...
function Trig_Abilities_Info_Actions takes nothing returns nothing
    ...
    if GetTriggerUnit() != gg_unit_h006_0035 then
    ...
    if GetTriggerUnit() == gg_unit_h006_0081 then
        ...
        if GetTriggerUnit() == gg_unit_h006_0075 then
            ...
            if GetTriggerUnit() == gg_unit_h006_0077 then
                ...
                if GetTriggerUnit() == gg_unit_h006_0079 then
                    ...
                    if GetTriggerUnit() == gg_unit_h006_0082 then
                        ...
                        if GetTriggerUnit() == gg_unit_h006_0076 then
                            ...
                            if GetTriggerUnit() == gg_unit_h006_0078 then
                                ...
                                if GetTriggerUnit() == gg_unit_h006_0080 then
                                    ...
                                    if GetTriggerUnit() == gg_unit_h006_0071 then
                                        ...
                                        if GetTriggerUnit() == gg_unit_h006_0069 then
                                            ...
                                            if GetTriggerUnit() == gg_unit_h006_0073 then
                                                ...
                                                if GetTriggerUnit() == gg_unit_h006_0067 then
